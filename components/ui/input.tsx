...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        // h-10 on touch screens keeps the tap target near 44px; the
        // original h-8 returns from md up, where a pointer is precise.
        // text-base on mobile is deliberate — iOS zooms into any field
        // under 16px on focus.
