...
export const SELECTION_ITEMS: SelectionItem[] = [
  ...
  item("shower-drain", "Shower drain", "plumbing", "Bathroom", 180, ["drain", "shower"]),
  item("shower-stone", "Stone surround", "tile", "Bathroom", 1400, ["stone", "marble", "slab"]),
  ...
  item("caulking", "Caulking", "adhesives", "Bathroom", 60, ["caulk", "silicone", "sealant"]),
  item("bath-trim", "Trim", "lumber", "Bathroom", 240, ["trim", "baseboard", "casing"]),
  ...
  item("floor-levelling", "Levelling compound", "concrete", "Interior", 220, ["level", "self-levelling", "patch"]),
  item("moisture-barrier", "Moisture barrier", "insulation", "Interior", 180, ["vapour", "moisture", "barrier", "membrane"]),
  item("floor-adhesive", "Flooring adhesive", "adhesives", "Interior", 190, ["adhesive", "thinset", "mortar"]),
  item("floor-fasteners", "Fasteners", "hardware", "Interior", 140, ["staple", "nail", "cleat", "tack"]),
